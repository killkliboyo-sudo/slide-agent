...
- **Slide Designer**
  ...
  - Gemini model discovery supported via CLI flag to list available models when an API key is present.
  - Snapshot testing: markdown previews compared against golden files to protect rendering regressions (PPTX preview content).
